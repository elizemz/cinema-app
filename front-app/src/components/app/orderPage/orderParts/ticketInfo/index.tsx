...
export const TicketInfo = ({
  ...
  return (
    <div className="flex flex-col justify-center m-auto lg:h-[800px] mb-96 bg-black sm:px-10 bg-opacity-80 rounded-2xl">
      <div className="grid lg:grid-cols-2">
        <div className="flex flex-col gap-4 m-auto justify-center items-center  text-white pt-20 lg:py-20 lg:mr-20">
