...
export const EventPage = (props: Props) => {
  return (
    <div className="w-full h-full mx-auto container flex justify-center flex-col-reverse text-white items-center">
      <div className="w-full flex mx-auto mt-20 sm:mt-32">
