            ...
            <div className="px-26 py-17.5 text-center">
              <Link className="mb-5.5 inline-block" href="/">
                <h1 className="text-2xl font-semibold text-black">
                  "Central-Cinema" Админ
                </h1>
              </Link>

              <p className="2xl:px-20">
                Central-Cinema админ эрхийн нэвтрэх хэсэгт тавтай морилно уу?
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            {loginuser ? (
              <div className="mx-auto w-[300px]">
                <h1 className="text-center mb-7">Та нэвтэрсэн байна.</h1>
                <div className="flex items-center">
                  <Link href="/profile" className="w-full text-primary ">
                    Профайл
                  </Link>
                  <button
              ...
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                  "Central-Cinema-Admin"-руу нэвтрэх
                </h2>
                ...
                <div>
                  ...
                  <div className="mb-5 flex flex-col justify-end">
                    <Link
                      href="/forgotpassword"
                      className="text-primary text-end mb-2"
                    >
                      Нууц үг мартсан
                    </Link>
                    <button
