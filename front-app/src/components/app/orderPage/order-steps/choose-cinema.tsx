...
export const ChooseCinema = () => {
  return (
    <ul className=" dark:text-white flex justify-center ">
      ...
      <div className="w-10 mx-2  md:w-20 h-[1px] mt-3 sm:mt-4 md:mt-6 bg-white"></div>
      <div className="flex items-center ">
        <div className="flex-col  max-h-20">
          <button className="items-center rounded-md sm:rounded-lg md:rounded-xl bg-white ml-2 sm:ml-1 md:ml-0">
            <MdOutlineChair className="w-6 h-5 sm:w-9 sm:h-[30px] md:w-12 md:h-10" />
          </button>
      ...
      <div className="flex items-center  ">
        <div className="flex-col  max-h-20">
          <button className="items-center  rounded-md sm:rounded-lg md:rounded-xl bg-white ml-2 sm:ml-1 md:ml-0">
            <LiaWalletSolid className="w-6 h-5 sm:w-9 sm:h-[30px] md:w-12 md:h-10" />
          </button>
